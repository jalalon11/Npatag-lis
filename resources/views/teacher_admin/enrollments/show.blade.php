                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <!-- Approve Section -->
                                            <div class="col-md-6">
                                                <form method="POST" action="{{ route('teacher-admin.enrollments.approve', $enrollment) }}">
                                                    @csrf
                                                    <div class="card border-success">
                                                        <div class="card-header bg-success text-white">
                                                            <h6 class="mb-0">Approve Enrollment</h6>
                                                        </div>
                                                        <div class="card-body">
                                                                ...
                                                                <select name="assigned_section_id" id="assigned_section_id" class="form-control" required>
                                                                    ...
                                                                    @foreach($sections as $section)
                                                                        ...
                                                                        <option value="{{ $section->id }}" 
                                                                                {{ $enrollment->preferred_section_id == $section->id ? 'selected' : '' }}
                                                                                {{ $isFull ? 'disabled' : '' }}
                                            ...
                                            <!-- Reject Section -->
                                            <div class="col-md-6">
                                                <form method="POST" action="{{ route('teacher-admin.enrollments.reject', $enrollment) }}">
                                                    @csrf
                                                    <div class="card border-danger">
                                                        <div class="card-header bg-danger text-white">
                                                            <h6 class="mb-0">Reject Enrollment</h6>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                            ...
                                                            <button type="submit" class="btn btn-danger btn-block" onclick="return confirm('Are you sure you want to reject this enrollment?')">
