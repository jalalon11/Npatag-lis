...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <table class="info-table">
            ...
            <tr>
                ...
                <td class="info-value">
                    @php
                        // Get total active students count for the school(s)
                        $totalActiveStudents = 0;
                        if (isset($schoolId)) {
                            // Single school filter
                            $totalActiveStudents = App\Models\Student::whereHas('section', function($query) use ($schoolId) {
            ...
            <tr>
                ...
                <td class="text-center">
                    @php
                        ...
                        if (isset($schoolId)) {
                            // Single school filter
                            $activeStudents = App\Models\Student::whereHas('section', function($query) use ($gradeLevel, $schoolId) {
    ...
    <div class="signature-section">
        <div class="signature-item">
            ...
            <p style="margin-top: 0;">System Administrator</p>
        </div>
