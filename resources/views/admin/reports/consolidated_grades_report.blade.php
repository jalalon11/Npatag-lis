    ...
    <div class="table-responsive">
        <table class="info-table">
            <tr>
                ...
                <td class="info-value">{{ isset($section) && $section->school ? $section->school->region : 'Region' }}</td>
            ...
            <tr>
                ...
                <td class="info-value">{{ isset($section) && $section->school ? $section->school->division_name : 'Division' }}</td>
