        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4 position-relative overflow-hidden animate__animated animate__fadeIn" style="animation-delay: 0.2s;">
                ...
                <div class="card-body bg-white p-0">
                    <div class="row g-0">
                        <!-- Registration keys removed - account creation is now admin-only -->

                        <!-- Quarter selection moved to Academic Management page -->
                        <div class="col-md-12 border-bottom">
                            <div class="quick-action-item d-flex align-items-center p-5 position-relative">
                                <div class="position-absolute start-0 top-0 bottom-0 w-1 bg-info opacity-0 transition-all hover-opacity-100"></div>
                                <div class="d-flex align-items-center justify-content-center me-4 bg-info bg-opacity-10 rounded-3" style="width: 80px; height: 80px;">
                                    <i class="fas fa-graduation-cap text-info fa-2x"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <h5 class="mb-2 fw-bold text-dark">Academic Management</h5>
                                    <p class="text-muted mb-3">Manage quarters, school year, principal details, and school information</p>
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="badge bg-info bg-opacity-10 text-info me-2 px-3 py-1">
                                            <i class="fas fa-calendar-alt me-1"></i> Current: {{ ['Q1' => '1st Quarter', 'Q2' => '2nd Quarter', 'Q3' => '3rd Quarter', 'Q4' => '4th Quarter'][\App\Models\SystemSetting::getSetting('global_quarter', 'Q1')] }}
                                        </span>
                                        <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-1">
                                            <i class="fas fa-school me-1"></i> {{ \App\Models\SystemSetting::getSetting('school_year', date('Y') . '-' . (date('Y') + 1)) }}
                                        </span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('admin.academics.index') }}" class="btn btn-info me-3">
                                            <i class="fas fa-cog me-2"></i>Manage Academic Settings
                                        </a>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    // Dashboard functionality - quarter management moved to Academic page
