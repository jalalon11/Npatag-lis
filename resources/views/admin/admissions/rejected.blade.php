...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Rejected Students</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.admissions.rejected') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <label class="form-label">&nbsp;</label>
                    <div class="d-grid">
                        <a href="{{ route('admin.admissions.rejected') }}" class="btn btn-outline-secondary">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Rejected Students List</h6>
        </div>
        <div class="card-body">
            @if($rejectedStudents->count() > 0)
                <div class="table-responsive">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach($rejectedStudents as $admission)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div class="text-muted small" style="max-width: 200px;">
                                            {{ $admission->rejection_reason ?? 'No reason provided' }}
                                        </div>
                                    </td>
                                    <td>
                ...
                <div class="d-flex justify-content-center">
                    {{ $rejectedStudents->appends(request()->query())->links() }}
                </div>
            @else
                <div class="text-center py-4">
                    <i class="fas fa-user-times fa-3x text-gray-300 mb-3"></i>
                    <h5 class="text-gray-600">No Rejected Students Found</h5>
                    <p class="text-muted">No rejected students match your current filters.</p>
