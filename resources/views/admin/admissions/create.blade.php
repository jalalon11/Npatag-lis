            ...
            <div>
                <div class=" d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('admin.admissions.index') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-arrow-left mr-1"></i> Back to Admissions
                    </a>
                </div>
                <div class="card border-0 shadow-sm bg-white">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.admissions.store') }}" method="POST" enctype="multipart/form-data" id="admissionForm">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="text-primary mb-3 fw-bold">Student Information</h5>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <h5 class="text-primary mb-3 fw-bold">Guardian Information</h5>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <h5 class="text-primary mb-3 fw-bold">Academic Information</h5>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted mt-1">Please select school and grade level first</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <h5 class="text-primary mb-3 fw-bold">Additional Information</h5>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 d-flex justify-content-end">
                                    <div class="form-group">
                                        <a href="{{ route('admin.admissions.index') }}" class="btn btn-secondary mr-4">
                                            <i class="fas fa-times"></i> Cancel
                                        </a>
                                        <button type="submit" class="btn btn-primary ml-2">
                                            <i class="fas fa-save pr-2"></i> Create Admission
                                        </button>
                                    </div>
                                </div>
                            </div>
