        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.sections.store') }}" method="POST" id="createSectionForm">
                        @csrf
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('student_limit') is-invalid @enderror" id="student_limit" name="student_limit" value="{{ old('student_limit') }}" min="1" max="100" placeholder="e.g. 40">
                                                <div class="form-text">Maximum number of students allowed in this section. Leave empty for no limit.</div>
                                                @error('student_limit')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="alert alert-secondary mb-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    @else
                                                        <div class="col-12">
                                                            <p class="text-muted mb-0">No teachers available. Please add teachers first.</p>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
